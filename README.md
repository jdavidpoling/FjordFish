...
### North Atlantic marine faunal computer vision dataset as part of the publication "Annotation strategy trade-offs for deep learning-based underwater fish detection".
